...
function initModel(waifuPath){
    ...
    console.group('init');
    console.log('%cLive2D','color:#ff0;background:#000;padding:2px',' - modelId:', modelId);
    console.log('%cLive2D','color:#ff0;background:#000;padding:2px',' - modelTexturesId:', modelTexturesId);
    console.groupEnd();
